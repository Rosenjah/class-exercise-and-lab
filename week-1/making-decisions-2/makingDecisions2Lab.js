...
var family = ['Tyler', 'Jordan', 'Ryan', 'Alice', 'Ireland','Rose'];
...
if (myFavoriteNumbers.length< 7) {
  console.log('There are not enough elememnts in the array')
}else {
...
//Code Here
for (let i = letters.length-1; i >= 0) {
